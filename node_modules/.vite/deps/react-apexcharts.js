            ...
            for (var a3 = 0; a3 < t4.data.length; a3++) {
              ...
              if (s3 || (f2.isFormatXY() ? s3 = i2[e3].data[a3].x : f2.isFormat2DArray() && (s3 = i2[e3].data[a3] ? i2[e3].data[a3][0] : "")), 0 === e3) {
                ...
                for (var o3 = 0; o3 < l2.globals.series.length; o3++)
                  f2.isFormatXY() ? h2.push(i2[o3].data[a3].y) : h2.push(g2[o3][a3]);
              }
    ...
    var j = function() {
      ...
      return r(t2, [{ key: "drawGridArea", value: function() {
        ...
        for (var i2, a2 = t3.globals.yAxisScale.length ? t3.globals.yAxisScale[0].result.length - 1 : 5, s2 = 0; s2 < t3.globals.series.length && (void 0 !== t3.globals.yAxisScale[s2] && (a2 = t3.globals.yAxisScale[s2].result.length - 1), !(a2 > 2)); s2++)
          ;
        return !t3.globals.isBarHorizontal || this.isRangeBar ? (i2 = this.xaxisLabels.length, this.isRangeBar && t3.globals.isBarHorizontal && (i2--, a2 = t3.globals.labels.length, t3.config.xaxis.tickAmount && t3.config.xaxis.labels.formatter && (i2 = t3.config.xaxis.tickAmount)), this._drawXYLines({ xCount: i2, tickAmount: a2 })) : (i2 = a2, a2 = t3.globals.xTickAmount, this._drawInvertedXYLines({ xCount: i2, tickAmount: a2 })), this.drawGridBands(i2, a2), { el: this.elg, elGridBorders: this.elGridBorders, xAxisTickWidth: t3.globals.gridWidth / i2 };
      ...
      return r(t2, [{ key: "init", value: function() {
        ...
        for (var d2 = t3; d2 < a2; d2++) {
          r2.dataPoints = Math.max(r2.dataPoints, l2[d2].length), r2.categoryLabels.length && (r2.dataPoints = r2.categoryLabels.filter(function(t4) {
            return void 0 !== t4;
          }).length), r2.labels.length && (r2.dataPoints = Math.max(r2.dataPoints, r2.labels.length));
    ...
    var yt = function() {
      ...
      return r(t2, [{ key: "draw", value: function(t3, i2) {
        ...
        for (var n2 = 0, l2 = 0; n2 < t3.length; n2++, l2++) {
          ...
          var L2 = s2.group({ class: "apexcharts-bar-goals-markers", style: "pointer-events: none" }), P2 = s2.group({ class: "apexcharts-bar-shadows", style: "pointer-events: none" });
    ...
    var Tt = function(t2) {
      ...
      return r(s2, [{ key: "draw", value: function(t3, i3) {
        ...
        for (var r2 = s3.group({ class: "apexcharts-rangebar-series apexcharts-plot-series" }), n2 = 0; n2 < t3.length; n2++) {
          ...
          for (var w2 = s3.group({ class: "apexcharts-datalabels", "data:realIndex": p2 }), k2 = s3.group({ class: "apexcharts-rangebar-goals-markers", style: "pointer-events: none" }), A2 = 0; A2 < a2.globals.dataPoints; A2++) {
    ...
    var Bt = function() {
      ...
      return r(t2, [{ key: "render", value: function() {
        ...
        return new Promise(function(s2, r2) {
          ...
          var l2 = new V(t3.ctx, o2), h2 = new q(t3.ctx, o2);
          if (null !== o2 && (l2.xAxisLabelCorrections(o2.xAxisTickWidth), h2.setYAxisTextAlignments(), a2.config.yaxis.map(function(t4, e3) {
            -1 === a2.globals.ignoreYAxisIndexes.indexOf(e3) && h2.yAxisTitleRotate(e3, t4.opposite);
