...
import { FaWpforms, FaList, FaTable, FaChartPie, FaArrowRightToBracket } from "react-icons/fa6";
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 px-5 sm:py-5">
        <NavLink to="/">
        ...
        <nav className="mt-2 py-4 px-4 lg:mt-3 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <RxDashboard className="fill-current" size={18} />
                        Dashboard
                        <svg
              ...
              {/* <!-- Menu Item Detail Order Billcomp --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/forms' || pathname.includes('forms')
                }
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <TbListDetails className="fill-current" size={18} />
                        Detail Order Billcomp
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                            open && 'rotate-180'
                          }`}
